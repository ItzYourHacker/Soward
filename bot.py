...
from ui import DropDownSelfRoleView, ButtonSelfRoleView
...
MONGO_URL = "mongodb+srv://RANDI:SHREEXD3110@cluster0.l8dzjae.mongodb.net/?retryWrites=true&w=majority"
...
class Bot(commands.AutoShardedBot):
    ...
    **Loaded hidden cogs:** {len(self.loaded_hidden)}/{len(self.loaded_hidden) + len(self.not_loaded_hidden)}
        ...
        #webhook = self.get_channel(1041776087291670559)
